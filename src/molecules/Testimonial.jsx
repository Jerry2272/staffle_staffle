const Testimonial = () => {
  const testimonials = [
    { name: "Ada Obasi", role: "Career Coach", video: "/src/assets/Testimonial_1.mp4" },
    { name: "Ufuoma Jefta Ojere", role: "Staffle's Community Member", video: "/src/assets/Testimonial_2.mp4" },
  ];
